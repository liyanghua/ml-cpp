...
/*
   ...
   */
static void scantree( node_t *node, long *max_depth, long *max_rules )
{
  static int depth = 0;
  int j;
...
/*
   ...
   */
static void scanrules( node_t *node, long class_id, long *depth, long *path, long maxdepth, long *table, long *tid )
{
  int j, i;
...
/*
   ...
   */
static void explain_rules( node_t *node, long cols, struct dsinfo_t *info, char **titles, long maxdepth, long maxrules )
{
...
int id3tree_create(const char **data, long cols, long rows, ...)
{
  long    *dataset  = NULL;
